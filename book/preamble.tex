...
\setCJKmainfont{KingHwaOldSong-GB.ttf}[Path=./assets/fonts/]
\setCJKfamilyfont{zhsong}{KingHwaOldSong-GB.ttf}[Path=./assets/fonts/]
\setCJKfamilyfont{zhkai}{KingHwaOldSong-GB.ttf}[Path=./assets/fonts/]
...
% ── 注释环境 ──────────────────────
% 字号更小（\footnotesize），靛青色，用于诗歌正文后的注释块
